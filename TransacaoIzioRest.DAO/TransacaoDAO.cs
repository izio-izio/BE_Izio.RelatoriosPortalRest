        ...
        public DadosConsultaTransacao ConsultaUltimasTransacao(long cod_pessoa,string anoMes)
        {
            ...
            try
            {
                ...
                sqlServer.Command.CommandText = $@"select distinct
                                                  ...
                                                  where
                                                      trs.dat_compra between '{anoMes}01 00:00:00' and '{anoMes}{DateTime.DaysInMonth(Convert.ToInt32(anoMes.Substring(0,4)), Convert.ToInt32(anoMes.Substring(4, 2))).ToString()} 23:59:59' and 
