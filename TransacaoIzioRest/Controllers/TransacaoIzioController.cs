    ...
    public class TransacaoIzioRestController : ApiController
    {
        ...
        public HttpResponseMessage ImportaTransacao([FromBody] DadosTransacaoOnline objTransacao, [FromUri] string tokenAutenticacao)
        {
            ...
            try
            {
                ...
                else if (objTransacao.cod_pessoa > 0 && !impTransacao.VerificaCodPessoaExiste(Convert.ToInt64(objTransacao.cod_pessoa), objTransacao.cupom, objTransacao.dat_compra, objTransacao.cod_loja))
                {
